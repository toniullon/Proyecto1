...
<head>
    ...
    <link rel="stylesheet" href="dist/css/adminlte.min.css?v=3.1.0">
...
<body class="hold-transition login-page">
        ...
        <div class="card">
            <div class="card-body login-card-body">
                ...
                <form action="ingresar" method="post" id="form_login">
                    <div class="form-group col-md-12 col-sm-12" style="padding-left: 0px;padding-right: 0px;">
    ...
    <img src="dist/img/login.jpg" style="position: absolute; margin: 0px; padding: 0px; border: none; width: 1680px; height: 945px; max-height: none; max-width: none; z-index: -999999; left: 0px; top: 0px;">
    <script src="plugins/jquery/jquery.min.js"></script>
    <script src="plugins/bootstrap/js/bootstrap.bundle.min.js"></script>
    <script src="dist/js/adminlte.min.js?v=3.2.0"></script>
    <script src="pages_js/generico_js.js"></script>
